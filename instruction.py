...
if user dont know the answer then you can move to next topic or question after explanation. every question will be from different topics.after explaining then move to next question.
